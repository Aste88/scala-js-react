...
object ScalaJSReact extends Build {
  ...
  val reactJs = "org.webjars" % "react" % "0.14.0" / "META-INF/resources/webjars/react/0.14.0/react.js" commonJSName "React"
  val reactJsDom = "org.webjars" % "react" % "0.14.0" / "META-INF/resources/webjars/react/0.14.0/react-dom.js" commonJSName "ReactDOM" dependsOn "META-INF/resources/webjars/react/0.14.0/react.js"
  ...
  .settings(
    ...
    jsDependencies ++= Seq(reactJs, reactJsDom),
    test in Test := {}
  )
